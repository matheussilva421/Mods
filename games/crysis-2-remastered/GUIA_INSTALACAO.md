...
Este guia cobre a instalacao e uso do trainer offline para Crysis 2 Remastered.
...
9. Configure o comando custom do STL para:
   - `/home/deck/tools/crysis2-remastered-trainer/steamdeck/stl_launch.sh %command%`
10. Se necessario, configure variaveis de ambiente:
   - `CE_BIN=/home/deck/tools/cheatengine/cheatengine-x86_64`
   - `TABLE_PATH=/home/deck/tools/crysis2-remastered-trainer/crysis2_remastered_basic.ct`
...
- `crysis2_remastered_basic.ct`: tabela do Cheat Engine
...
1. Copie este projeto para o Deck, por exemplo:
   - `/home/deck/tools/crysis2-remastered-trainer`
2. Garanta permissao de execucao nos scripts:
   - `chmod +x /home/deck/tools/crysis2-remastered-trainer/steamdeck/*.sh`
...
2. O launcher abrira o Cheat Engine com `crysis2_remastered_basic.ct`.
3. A tabela faz auto-attach em `Crysis2Remastered.exe`.
4. Hotkeys:
   - `F1`: vida infinita
...
```bash
/home/deck/tools/crysis2-remastered-trainer/steamdeck/check_build.sh
```
...
- Build check falha:
  - Atualize `build.lock` somente apos revalidar os 4 scripts na build nova.
