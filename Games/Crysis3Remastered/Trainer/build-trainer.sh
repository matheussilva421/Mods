...
src_dir="$root/src"
out_dir="$root/dist"
out_exe="$out_dir/Crysis3RemasteredTrainer.exe"
...
cheat_deck_exe_path="$cheat_deck_dir/Crysis3Remastered-CheatDeck.exe"
...
cp "$root/profiles/crysis3-remastered.fr-v1.4.json" "$profiles_out/"
cp "$out_exe" "$cheat_deck_exe_path"
cp "$out_exe" "$portable_dir/Crysis3RemasteredTrainer.exe"
cp "$root/profiles/crysis3-remastered.fr-v1.4.json" "$portable_profiles_dir/"
